/**
 * THE Design Prototype Workshop logo — the Android launcher icon, verbatim
 ...
 *
 * The mark itself is unchanged by the rename from `FieldRepoLogo`: the path data
 * here is a hand-transcription of the Android drawable, so the two must be edited
 * together or the web header and the phone's launcher icon quietly stop being the
 * same logo — a divergence nobody notices from inside either surface alone.
 */
