...
export function ProductForm({
  ...
  */
  ...
  /*
    THE WORKSHOP THIS PRODUCT WAS DOCUMENTED AT — ONE CONTROL, TWO DROPDOWNS.
    ...
    `Workshop`, and a product created from a WORKSHOP-scoped picker that is filed against a different
    sitting is a product that picker can never show again. It arrives as `initialWorkshopId`, which is
