...
export type SearchableSelectProps = {
   ...
   * while looking, in the source, like the field was marked. Expressing "this answer was refused" on
   * this control properly means giving it `role="combobox"` and the popup semantics that go with
   * it; until then the refusal reaches the reader through `describedBy` and its own live region.
   */
  describedBy?: string;
  /**
