...
_PLACES: tuple[Place, ...] = (
    ...
    Place(
        ...
        74.6269,
        Precision.DISTRICT,
        ("akolachittorgarh", "akolarajasthan", "akola"),
    ...
    Place(
        "kachchh",
        "Kachchh",
        "Kachchh district, Gujarat (shown at Bhuj)",
        "Gujarat",
        23.2419,
        69.6669,
        Precision.DISTRICT,
        ("kachchh", "kutch", "kachchhbhuj", "bhuj"),
        district="Kachchh",
    ),
    ...
    Place(
        ...
        83.9812,
        Precision.TOWN,
        ("sambalpur", "sambhalpur"),
        district="Sambalpur",
    ),
    Place(
        "sonepur",
        "Sonepur",
        "Subarnapur district, Odisha",
        "Odisha",
        20.8333,
        83.9167,
        Precision.TOWN,
        ("sonepur", "subarnapur", "sonpur"),
        district="Subarnapur",
    ),
    Place(
        "boudh",
        "Boudh",
        "Boudh district, Odisha",
        "Odisha",
        20.8379,
        84.3264,
        Precision.TOWN,
    ...
    Place(
        "raghurajpur",
        "Raghurajpur",
        "Puri district, Odisha (Pattachitra)",
        "Odisha",
        19.8833,
        85.8000,
        Precision.TOWN,
    ...
    Place(
        ...
        79.7710,
        Precision.TOWN,
        ("bageshwar", "bageswar", "bagheswar", "bagheshwar"),
        district="Bageshwar",
    ),
    Place(
        "rudraprayag",
    ...
    Place(
        ...
        78.0322,
        Precision.TOWN,
        ("dehradun", "ballupur", "ballupurdehradun"),
        district="Dehradun",
    ),
    # Jammu and Kashmir
    Place(
