...
#
# `fieldrepo-queue` is the live systemd unit's real, pre-rebrand name, not a line the "Design
# Prototype Workshop" rename missed. The deploy workflow restarts it by that literal string; the
# full argument for leaving it alone is in the module docstring of `app/worker.py`.
