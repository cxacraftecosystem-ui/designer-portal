...
**Corresponding artefact:** Design Prototype Workshop — a web, Android and API system in which craft
and textile designers capture the stages of a design & prototype development workshop and generate
the resulting report offline. Repository `D:/Portal_Development_Designer`, snapshot commit
`a0fa3a85`, 2026-07-26.
