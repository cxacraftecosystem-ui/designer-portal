...
**Who this is for:** the person running the workshop — a craft or textile designer, a design student,
a scholar documenting a design & prototype development workshop. Not an engineer. Nothing below assumes you can read code, and nothing below
...
**What it does not cover:** the step-by-step order of the capture screens and workshop stages. That is
...
- **Android OAuth client** — needs package name `com.designprototype.workshop` and the signing certificate
