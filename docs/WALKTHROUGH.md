...
Thickness, Weight, Radius, Maker, Tradition type, Replacement cost, Suggestions for improvement,
Remarks, Status, Process stages, Tool media, Location (GPS fix or map pin).
